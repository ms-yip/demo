        ...
        <el-tabs v-model="activeTab">
          <el-tab-pane label="node信息" name="node信息">
            ...
            <el-table :data="curSelectNode?.data?.inputParams" style="width: 100%" border>
              ...
              <el-table-column prop="paramValue" label="paramValue" />
            ...
            其他参数
            <pre style="height: 250px;border: 1px solid #cccccc;backgroundColor: #efefef">{{ curSelectNode }}</pre>
...
import { createPorts } from './shape';
import { onMounted, ref, nextTick, reactive } from "vue";
import insertCss from 'insert-css';
import { Selection } from "@antv/x6-plugin-selection";
import { MiniMap } from "@antv/x6-plugin-minimap";
import { logicalExpression } from '@babel/types';
import { source } from '@/views/flow/source';
import { flowNodeGenerator, displayData } from '@/views/flow/utils';
